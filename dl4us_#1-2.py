...
model.add(Dense(128, activation='relu', kernel_initializer='he_normal', kernel_regularizer=None))
model.add(Dropout(0.5))
model.add(Dense(64, activation='relu', kernel_initializer='he_normal', kernel_regularizer=None))
model.add(Dropout(0.5))
...
history = model.fit(x_train, y_train, batch_size=2048, epochs=2000, validation_split=0.01, callbacks=[EarlyStopping(monitor='val_loss', patience=20, verbose=1)])
