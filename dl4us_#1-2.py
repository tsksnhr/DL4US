...
#history = model.fit(x_train, y_train, batch_size=512, epochs=200, validation_split=0.1)
history = model.fit(x_train, y_train, batch_size=1024, epochs=500, validation_split=0.1, callbacks=[EarlyStopping(monitor='val_loss', patience=25, verbose=1)])
